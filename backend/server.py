...
model_path = "model.keras"  # Replace with actual model path
...
def upload_image():
    ...
    solar_energy_per_unit_area = solar_data['properties']['parameter']['ALLSKY_SFC_SW_DWN']['20230101']
    energy = solar_energy_per_unit_area * area_building
